...
cv2.namedWindow("Trackbars",400,300)
...
cv2.createTrackbar('Hue low','Trackbars',150,179,onTrack2)
cv2.createTrackbar('Hue low','Trackbars',80,255,onTrack3)
cv2.createTrackbar('Hue low','Trackbars',255,255,onTrack4)
cv2.createTrackbar('Hue low','Trackbars',134,255,onTrack5)
cv2.createTrackbar('Hue low','Trackbars',255,255,onTrack6)

#Input Image
image = cv2.imread('.task_1/ball.png')
